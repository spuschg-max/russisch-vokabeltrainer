const CACHE='russisch-vokabeltrainer-v7';
const ASSETS=['./','./index.html','./styles.css','./data.js','./app.js','./features.js','./speaking.js','./forms.js','./voice-persistence.js','./manifest.webmanifest','./app-icon.svg'];
