const CACHE='russisch-vokabeltrainer-v41';
const ASSETS=['./','./index.html','./styles.css','./data.js','./app.js','./features.js','./speaking.js','./forms.js','./audio-toggle.js','./speech-unlock.js','./speech-tolerance.js','./speech-segmentation.js','./voice-controller.js','./voice-selfcheck.js','./voice-add.js','./learning-ui.js','./motion-hints.js','./reveal-answer.js','./forms-voice.js','./update-helper.js','./exercise-packages.js','./import-code.js','./standard-a1a2-data.js','./standard-b1-data.js','./standard-pack.js','./manifest.webmanifest','./app-icon.svg'];
