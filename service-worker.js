const CACHE='russisch-vokabeltrainer-v8';
const ASSETS=['./','./index.html','./styles.css','./data.js','./app.js','./features.js','./speaking.js','./forms.js','./voice-persistence.js','./forms-voice.js','./manifest.webmanifest','./app-icon.svg'];
