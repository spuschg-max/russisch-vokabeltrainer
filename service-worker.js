const CACHE='russisch-vokabeltrainer-v51';
const ASSETS=['./','./index.html','./styles.css','./data.js','./app.js','./features.js','./speaking.js','./forms.js','./audio-toggle.js','./speech-unlock.js','./speech-tolerance.js','./speech-segmentation.js','./speech-start-guard.js','./voice-controller.js','./voice-selfcheck.js','./wrong-study-pause.js','./voice-add.js','./learning-ui.js','./motion-hints.js','./reveal-answer.js','./problem-vocab.js','./stress-lexicon-data.js','./stress-display.js','./sentence-bank-data.js','./sentence-drill.js','./conjugation-data-bridge.js','./conjugation-drill.js','./conjugation-study.js','./forms-voice.js','./update-helper.js','./exercise-packages.js','./import-code.js','./standard-a1a2-data.js','./standard-b1-data.js','./standard-pack.js','./manifest.webmanifest','./app-icon.svg'];
