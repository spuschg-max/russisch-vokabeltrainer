const CACHE='russisch-vokabeltrainer-v9';
const ASSETS=['./','./index.html','./styles.css','./data.js','./app.js','./features.js','./speaking.js','./forms.js','./voice-persistence.js','./forms-voice.js','./update-helper.js','./manifest.webmanifest','./app-icon.svg'];
